    ...
    return (
        <footer
            ...
            <p className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-bold text-secondary font-serif transition-colors">Beauty Salon</span>
                <Sparkles className="h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 text-secondary fill-secondary" />
            </p>
            <p className="text-xs sm:text-sm md:text-base lg:text-base text-center">&copy; 2025 Beauty Salon. All rights
                reserved.</p>
        </footer>
    )
}