    ...
    return (
        <>
            <section id="heroSection"
                ...
                <h2 className="text-secondary text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-center leading-tight">
                ...
                <Link
                    className="font-bold shadow-lg text-lg sm:text-xl md:text-2xl  mt-6 sm:mt-8 md:mt-10 lg:mt-5 rounded-full py-3 px-8 sm:py-3.5 sm:px-10 lg:py-5 lg:px-15 bg-secondary text-primary-foreground hover:bg-button-hover transition-colors"
